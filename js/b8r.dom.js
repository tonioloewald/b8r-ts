...
import { makeArray, forEachKey } from './b8r.iterators';
export const isVisible = (element, includeParents = false) => element &&
...
export const rectsOverlap = (r, s) => !(r.top > s.top + s.height ||
...
export const findWithin = (element, selector, includeSelf = false) => {
...
export const findOneWithin = (element, selector, includeSelf) => includeSelf &&
...
export const findHighestZ = (selector = 'body *') => [...document.querySelectorAll(selector)]
    ...
    .reduce((z, highest = Number.MIN_SAFE_INTEGER) => isNaN(z) || z < highest ? highest : z);
