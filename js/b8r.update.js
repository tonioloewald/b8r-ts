...
const expectCustomElement = async (tagName) => {
    ...
    if (window.customElements.get(tagName) || _expectedCustomElements.includes(tagName))
        return;
...
_setForceUpdate, asyncUpdate, getUpdateList, _triggerChange, _afterUpdate, afterUpdate, touchElement, touchByPath, expectCustomElement };
