...
// @ts-ignore tsc doesn't know about ResizeObserver
...
const makeWebComponent = (tagName, { superClass = HTMLElement, // the class you're exetending
value = false, // expect boolean
style = false, // expect object
// @ts-ignore tsc is confused
...
role = '' // expect string
    ...
    // @ts-ignore tsc doesn't understand the destructuring?
    if (methods.render) {
        // @ts-ignore
        methods = Object.assign({ queueRender(change = false) {
    ...
    const componentClass = class extends superClass {
            ...
            if (attributeNames.length) {
                ...
                const observer = new MutationObserver((mutationsList) => {
                    ...
                    mutationsList.forEach((mutation) => {
                        // @ts-ignore tsc doesn't know about ResizeObserver events
        ...
        connectedCallback() {
            ...
            // @ts-ignore tsc apparently can't see the in-scope destructured paramter
...
export { fragment, makeElement, makeWebComponent, div, slot, input, button, label, span, text, dispatch };
