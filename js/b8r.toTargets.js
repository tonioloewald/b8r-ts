...
import { imgSrc } from './b8r.imgSrc';
import { getComponentWithMethod } from './b8r.events';
import describe from './describe';
import { dateFormat } from '../third-party/date.format';
    ...
    return {
        ...
        attr: function (element, value, dest) {
            if (value === undefined || value === null || value === false) {
                ...
                if (dest === 'src' && typeof element.load === 'function')
                    element.load();
            }
        },
        ...
        timestamp: function (element, zulu, format) {
            if (!zulu) {
                ...
                const date = new Date(zulu);
                element.textContent = dateFormat(date, format);
            }
        },
